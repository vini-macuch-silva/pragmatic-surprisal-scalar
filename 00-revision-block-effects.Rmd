...
d2Logic %>% 
  ...
  pivot_wider(id_cols = trial_name, names_from = logCon, values_from = mean_RT) %>% 
  mutate(
...
m_fullRS_raw <- RT_SHAPE_trial_raw$RT_SHAPE_trial_fullRE_raw %>%
  ...
  mutate(`b_logConEinigeUnbiased:trial_nametask_three_2_new` = b_logConEinigeUnbiased +  b_trial_nametask_three_2 + `b_logConEinigeUnbiased:trial_nametask_three_2`,
         `b_logConEinigeUnbiased:trial_nametask_three_3_new` = b_logConEinigeUnbiased + b_trial_nametask_three_3 + `b_logConEinigeUnbiased:trial_nametask_three_3`,
         `b_logConEinigeUnbiased:trial_nametask_three_4_new` = b_logConEinigeUnbiased + b_trial_nametask_three_4 + `b_logConEinigeUnbiased:trial_nametask_three_4`,
         `b_logConEinigeInfelict:trial_nametask_three_2_new` = b_logConEinigeInfelict + b_trial_nametask_three_2 + `b_logConEinigeInfelict:trial_nametask_three_2`,
         `b_logConEinigeInfelict:trial_nametask_three_3_new` = b_logConEinigeInfelict + b_trial_nametask_three_3 + `b_logConEinigeInfelict:trial_nametask_three_3`,
         `b_logConEinigeInfelict:trial_nametask_three_4_new` = b_logConEinigeInfelict + b_trial_nametask_three_4 + `b_logConEinigeInfelict:trial_nametask_three_4`,
         `b_logConEinigeFalse:trial_nametask_three_2_new` = b_logConEinigeFalse + b_trial_nametask_three_2 + `b_logConEinigeFalse:trial_nametask_three_2`,
         `b_logConEinigeFalse:trial_nametask_three_3_new` = b_logConEinigeFalse + b_trial_nametask_three_3 + `b_logConEinigeFalse:trial_nametask_three_3`,
         `b_logConEinigeFalse:trial_nametask_three_4_new` = b_logConEinigeFalse + b_trial_nametask_three_4 + `b_logConEinigeFalse:trial_nametask_three_4`) %>% 
...
m_fullRS_log <- RT_SHAPE_trial %>%
  ...
  mutate(`b_logConEinigeUnbiased:trial_nametask_three_2_new` = b_logConEinigeUnbiased + b_trial_nametask_three_2 + `b_logConEinigeUnbiased:trial_nametask_three_2`,
         ...
         `b_logConEinigeFalse:trial_nametask_three_2_new` = b_logConEinigeFalse + b_trial_nametask_three_2 + `b_logConEinigeFalse:trial_nametask_three_2`,
         `b_logConEinigeFalse:trial_nametask_three_3_new` = b_logConEinigeFalse + b_trial_nametask_three_3 + `b_logConEinigeFalse:trial_nametask_three_3`,
         `b_logConEinigeFalse:trial_nametask_three_4_new` = b_logConEinigeFalse + b_trial_nametask_three_3 + `b_logConEinigeFalse:trial_nametask_three_4`) %>% 
  gather_draws(b_trial_nametask_three_2,
               b_trial_nametask_three_3,
               b_trial_nametask_three_4,
               b_logConEinigeUnbiased,
...
m_fullRS_raw <- RT_SHAPE_trial_raw$RT_SHAPE_trial_fullRE_raw %>%
  ...
  mutate(`b_logConAlleBiased:trial_nametask_three_2_new` = b_logConAlleBiased +  b_trial_nametask_three_2 + `b_logConAlleBiased:trial_nametask_three_2`,
         `b_logConAlleBiased:trial_nametask_three_3_new` = b_logConAlleBiased + b_trial_nametask_three_3 + `b_logConAlleBiased:trial_nametask_three_3`,
         `b_logConAlleBiased:trial_nametask_three_4_new` = b_logConAlleBiased + b_trial_nametask_three_4 + `b_logConAlleBiased:trial_nametask_three_4`,
         `b_logConAlleUnbiased:trial_nametask_three_2_new` = b_logConAlleUnbiased +  b_trial_nametask_three_2 + `b_logConAlleUnbiased:trial_nametask_three_2`,
         `b_logConAlleUnbiased:trial_nametask_three_3_new` = b_logConAlleUnbiased + b_trial_nametask_three_3 + `b_logConAlleUnbiased:trial_nametask_three_3`,
         `b_logConAlleUnbiased:trial_nametask_three_4_new` = b_logConAlleUnbiased + b_trial_nametask_three_4 + `b_logConAlleUnbiased:trial_nametask_three_4`,
         `b_logConAlleFalse:trial_nametask_three_2_new` = b_logConAlleFalse + b_trial_nametask_three_2 + `b_logConAlleFalse:trial_nametask_three_2`,
         `b_logConAlleFalse:trial_nametask_three_3_new` = b_logConAlleFalse + b_trial_nametask_three_3 + `b_logConAlleFalse:trial_nametask_three_3`,
         `b_logConAlleFalse:trial_nametask_three_4_new` = b_logConAlleFalse + b_trial_nametask_three_4 + `b_logConAlleFalse:trial_nametask_three_4`) %>% 
  gather_draws(b_logConAlleBiased,
...
m_fullRS_log <- RT_SHAPE_trial %>%
  ...
  mutate(`b_logConAlleBiased:trial_nametask_three_2_new` = b_logConAlleBiased +  b_trial_nametask_three_2 + `b_logConAlleBiased:trial_nametask_three_2`,
         ...
         `b_logConAlleFalse:trial_nametask_three_2_new` = b_logConAlleFalse + b_trial_nametask_three_2 + `b_logConAlleFalse:trial_nametask_three_2`,
         `b_logConAlleFalse:trial_nametask_three_3_new` = b_logConAlleFalse + b_trial_nametask_three_3 + `b_logConAlleFalse:trial_nametask_three_3`,
         `b_logConAlleFalse:trial_nametask_three_4_new` = b_logConAlleFalse + b_trial_nametask_three_3 + `b_logConAlleFalse:trial_nametask_three_4`) %>% 
  gather_draws(b_logConAlleBiased,
               `b_logConAlleBiased:trial_nametask_three_2_new`,
               `b_logConAlleBiased:trial_nametask_three_3_new`,
               `b_logConAlleBiased:trial_nametask_three_4_new`,
...
### Hypothesis tests for full group-level models

```{r}
# effect 'einige' block 1
brms::hypothesis(RT_SHAPE_trial, "Intercept + logConEinigeUnbiased > Intercept")
# effect 'einige' block 2
brms::hypothesis(RT_SHAPE_trial, "Intercept + logConEinigeUnbiased + trial_nametask_three_2 + logConEinigeUnbiased:trial_nametask_three_2 > Intercept + trial_nametask_three_2 ")
# effect 'einige' block 3
brms::hypothesis(RT_SHAPE_trial, "Intercept + logConEinigeUnbiased + trial_nametask_three_3 + logConEinigeUnbiased:trial_nametask_three_3 > Intercept + trial_nametask_three_3 ")
# effect 'einige' block 4
brms::hypothesis(RT_SHAPE_trial, "Intercept + logConEinigeUnbiased + trial_nametask_three_4 + logConEinigeUnbiased:trial_nametask_three_4 > Intercept + trial_nametask_three_4")


# effect 'alle' block 1
brms::hypothesis(RT_SHAPE_trial, "Intercept + logConAlleUnbiased > Intercept + logConAlleBiased")
# effect 'alle' block 2
brms::hypothesis(RT_SHAPE_trial, "Intercept + logConAlleUnbiased + trial_nametask_three_2 + logConAlleUnbiased:trial_nametask_three_2 > Intercept + logConAlleBiased + trial_nametask_three_2 + logConAlleBiased:trial_nametask_three_2")
# effect 'alle' block 3
brms::hypothesis(RT_SHAPE_trial, "Intercept + logConAlleUnbiased + trial_nametask_three_3 + logConAlleUnbiased:trial_nametask_three_3 > Intercept + logConAlleBiased + trial_nametask_three_3 + logConAlleBiased:trial_nametask_three_3")
# effect 'alle' block 4
brms::hypothesis(RT_SHAPE_trial, "Intercept + logConAlleUnbiased + trial_nametask_three_4 + logConAlleUnbiased:trial_nametask_three_4 > Intercept + logConAlleBiased + trial_nametask_three_4 + logConAlleBiased:trial_nametask_three_4")
```
